                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg shadow-gray-200/50">
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-3" noValidate>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-4">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                                >
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-6">
                                <Link
                                    className="flex w-full justify-center items-center gap-2 rounded-xl bg-transparent px-3 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-all"
                                    to="/register"
                                >
                                    Register Account
                                </Link>
