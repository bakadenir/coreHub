        ...
        <div className="flex flex-col min-h-screen bg-background-light font-sans text-text-primary relative overflow-hidden">
            ...
            <main className="w-full max-w-4xl mx-auto px-6 md:px-12 py-12 flex-grow relative z-10">
                ...
                <div className="flex flex-col gap-12">
                                ...
                                <div className="space-y-2.5">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-gray-400">{location.length}/100</span>
                                        </div>
                                        <button
                                            type="button"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <input
                                        ...
                                        readOnly
                                        disabled
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-500 cursor-not-allowed text-[15px] shadow-sm outline-none"
                                    />
                                    ...
                                    <div className="flex items-center justify-between py-2">
                                        ...
                                        {typeof Notification !== 'undefined' && Notification.permission === 'denied' ? (
                                            <div className="text-right">
                                                <span className="px-4 py-2 text-sm font-medium bg-red-100 text-red-700 rounded-xl">
                                                    Blocked
                                                </span>
                                            ...
                                            <button
                                                ...
                                                className={`px-4 py-2.5 text-sm font-medium rounded-xl transition-colors ${typeof Notification !== 'undefined' && Notification.permission === 'granted'
                                    ...
                                    <div className="flex items-center justify-between py-2">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                disabled={isSavingNotifSetting}
                                                className={`appearance-none w-full pl-4 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 outline-none focus:border-gray-400 cursor-pointer ${isSavingNotifSetting ? 'opacity-50 cursor-not-allowed' : ''}`}
                                            >
                    ...
                    <section>
                        <h2 className="text-3xl font-extrabold tracking-tight mb-8 text-gray-900">Account Actions</h2>

                        <div className="bg-[#fdfdfd] border border-gray-200 rounded-xl p-8 shadow-sm">
                            <div className="flex items-start justify-between">
                                ...
                                <button
                                    ...
                                    className="px-5 py-2.5 text-sm font-medium bg-zinc-900 text-white rounded-xl hover:bg-black transition-colors disabled:opacity-50 flex items-center gap-2 shrink-0"
                                >
                                    {isDeletingAccount && (
                                        <RefreshCw size={16} className="animate-spin" />
                                    )}
            ...
            <ConfirmDialog
                ...
                itemName={`${name || user?.name || 'your account'}`}
                message={`This will permanently delete the ${name || user?.name || 'your'} account and all of its data.`}
                confirmLabel="I understand, delete this account"
                variant="danger"
                isLoading={isDeletingAccount}
                confirmText={name || user?.name || 'delete'}
            />
        </div>
    );
}
