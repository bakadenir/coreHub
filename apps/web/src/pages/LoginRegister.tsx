...
export default function LoginRegister() {
    ...
    const socialButtons = (
        <div className="flex gap-4 mb-4">
            {/* Google - Temporarily disabled due to Chrome compatibility issues */}
            <button type="button" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors bg-[#fdfdfd] shadow-sm opacity-50" onClick={() => showToast('Google login coming soon!', 'info')} title="Coming soon">
