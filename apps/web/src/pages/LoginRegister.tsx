...
export default function LoginRegister() {
    ...
    const socialButtons = (
        <div className="flex gap-4 mb-4">
            ...
            {/* GitHub */}
            <button type="button" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors bg-[#fdfdfd] shadow-sm" onClick={() => showToast('GitHub login coming soon!', 'info')}>
            ...
            {/* Facebook */}
            <button type="button" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors bg-[#fdfdfd] shadow-sm" onClick={() => showToast('Facebook login coming soon!', 'info')}>
