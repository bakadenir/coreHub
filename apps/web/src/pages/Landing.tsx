            ...
            <main className="flex-1 flex flex-col relative z-10">
                ...
                <section className="py-24 bg-[#fdfdfd]/50 border-t border-gray-200/50 backdrop-blur-sm">
                    <div className="w-full max-w-[1200px] mx-auto px-4 md:px-10 flex flex-col gap-16">
                        ...
                        {/* Marquee Container - only animates when visible */}
                        <div
                        ...
                        >
                            {/* Fade edges */}
                            <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#fdfdfd] to-transparent z-10 pointer-events-none"></div>
                            <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#fdfdfd] to-transparent z-10 pointer-events-none"></div>

                            {/* Marquee content - duplicated for seamless loop */}
                            <div className="marquee-content flex gap-6 w-max">
                                {/* First set */}
                                {[
                                    { icon: <CheckCircle size={24} />, title: 'Habit Tracker', desc: 'Build steel-strong habits with visual streaks and daily targets.' },
                                    { icon: <Calendar size={24} />, title: 'Smart Schedule', desc: 'Time-block your day effortlessly and never miss a beat.' },
                                    { icon: <FileEdit size={24} />, title: 'Quick Notes', desc: 'Capture fleeting thoughts instantly in a distraction-free editor.' },
                                    { icon: <LinkIcon size={24} />, title: 'Link Vault', desc: 'Save resources and bookmarks for later reading and reference.' },
                                    { icon: <ListTodo size={24} />, title: 'Todo Lists', desc: 'Organize tasks with smart lists, priorities, and subtasks.' },
                                ].map((feature, i) => (
                                    <div key={`a-${i}`} className="group flex flex-col gap-4 rounded-xl border border-gray-100 bg-[#fdfdfd] p-6 hover:border-gray-300 hover:shadow-lg transition-all duration-300 w-64 flex-shrink-0">
                                ...
                                {[
                                    ...
                                    <div key={`b-${i}`} className="group flex flex-col gap-4 rounded-xl border border-gray-100 bg-[#fdfdfd] p-6 hover:border-gray-300 hover:shadow-lg transition-all duration-300 w-64 flex-shrink-0">
                                        <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-lg text-gray-800 group-hover:bg-zinc-900 group-hover:text-white transition-all duration-300">
                                            {feature.icon}
                                        </div>
                                        <div className="flex flex-col gap-1.5">
            ...
            <footer className="py-10 bg-[#fdfdfd] border-t border-gray-200 relative z-10">
                <div className="w-full max-w-[1200px] mx-auto px-4 md:px-10 flex flex-col gap-6 items-center text-center">
                    <div className="flex items-center gap-2">
                        <img src="/logo.png" alt="Logo" width="24" height="24" className="size-6 object-contain" />
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://www.instagram.com/nahkreatif_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-text-primary transition-colors" title="Instagram">
